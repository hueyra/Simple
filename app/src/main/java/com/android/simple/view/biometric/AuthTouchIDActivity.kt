 ...
 * Desc : 授权触控ID页面
 */
class AuthTouchIDActivity : BaseBindingActivity<ActivityBiometricAuthBinding>(),
    ...
    override fun initBinding() {
        mBinding.apply {
            ...
            afaIvAuthImg.setImageResource(com.github.hueyra.biometricauth.R.mipmap.ic_touch_id_green)
            afaIvAuthText.text = ("点击授权使用指纹识别")
