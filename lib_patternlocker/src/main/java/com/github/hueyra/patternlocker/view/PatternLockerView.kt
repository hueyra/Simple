...
import com.github.hueyra.patternlocker.def.*
...
import com.github.hueyra.patternlocker.inte.ILockerLinkedLineView
...
open class PatternLockerView @JvmOverloads constructor(
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?, defStyleAttr: Int) {
        val ta = context.obtainStyledAttributes(
            attrs,
            R.styleable.PatternLockerView, defStyleAttr, 0
        )

        val normalColor = ta.getColor(
            R.styleable.PatternLockerView_plv_color,
        ...
        val hitBorderColor = ta.getColor(
            R.styleable.PatternLockerView_plv_hitBorderColor,
            DefaultConfig.defaultHitBorderColor
        )
        val errorBorderColor = ta.getColor(
            R.styleable.PatternLockerView_plv_errorBorderColor,
        ...
        // style
        val styleDecorator = DefaultStyleDecorator(
            normalColor,//默认色
            hitColor,//链接点 颜色
            hitBorderColor,//链接点边框 颜色
            errorColor,
            errorBorderColor,
            lineWidth
        )
