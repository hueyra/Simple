...
public class MyWheelTime {
    ...
    private void setLunar(int year, final int month, int day, boolean isLeap, int h, int m, int s) {
        // 年
        wv_year = (WheelView) view.findViewById(R.id.dpv_wv_date_year);
        ...
        // 月
        wv_month = (WheelView) view.findViewById(R.id.dpv_wv_date_month);
        ...
        // 日
        wv_day = (WheelView) view.findViewById(R.id.dpv_wv_date_day);
        ...
        wv_hours = (WheelView) view.findViewById(R.id.dpv_wv_date_hours);
        wv_hours.setAdapter(new NumericWheelAdapter(0, 23));
        //wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字
        wv_hours.setCurrentItem(h);
        wv_hours.setGravity(gravity);

        wv_minutes = (WheelView) view.findViewById(R.id.dpv_wv_date_minutes);
        ...
        wv_seconds = (WheelView) view.findViewById(R.id.dpv_wv_date_seconds);
...
//                maxItem = endD;
    ...
    public String getTimeDate() {
        ...
        if (currentYear == startYear) {
           /* int i = wv_month.getCurrentItem() + startMonth;
            ...
            if ((wv_month.getCurrentItem() + startMonth) == startMonth) {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        .append(getTimeString(wv_month.getCurrentItem() + startMonth)).append("-")
                        .append(getTimeString(wv_day.getCurrentItem() + startDay));
            } else {
                sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                        .append(getTimeString(wv_month.getCurrentItem() + startMonth)).append("-")
                        .append(getTimeString(wv_day.getCurrentItem() + 1));
            }

        } else {
            sb.append((wv_year.getCurrentItem() + startYear)).append("-")
                    .append(getTimeString(wv_month.getCurrentItem() + 1)).append("-")
                    .append(getTimeString(wv_day.getCurrentItem() + 1));
        }
    ...
    private String getTimeString(int mmOrDd) {
        return mmOrDd < 10 ? "0" + mmOrDd : String.valueOf(mmOrDd);
    }
