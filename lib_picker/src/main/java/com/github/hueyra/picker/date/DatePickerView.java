...
public class DatePickerView extends LinearLayout {
    ...
    public DatePickerView(Context context) {
        super(context);
        LayoutInflater.from(context).inflate(R.layout.layout_date_picker_view, this, true);
    }
    ...
    public void setPickerOptions(PickerOptions pickerOptions) {
        ...
        wheelTime = new MyWheelTime(this, mPickerOptions.type, mPickerOptions.textGravity, mPickerOptions.textSizeContent);
